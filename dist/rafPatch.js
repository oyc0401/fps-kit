...
exports.enableRafPatch = enableRafPatch;
exports.disableRafPatch = disableRafPatch;
class RafPatch {
...
// RafPatch 싱글톤 인스턴스
let _rafPatchSingleton = null;
function getRafPatchSingleton() {
...
// 외부에서 쓸 함수형 API
function enableRafPatch(fps) {
    getRafPatchSingleton().enable(fps);
}
function disableRafPatch() {
